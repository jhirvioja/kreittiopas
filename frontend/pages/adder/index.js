    ...
    <div className="postformwrapper">
      <form onSubmit={handleSubmit}>
        ...
        <input
          ...
          name="title"
          type="text"
          defaultValue={'Kirjoita tähän otsikko'}
        ...
        <input
          ...
          name="imgsrc"
          type="text"
          defaultValue={'https://i.imgur.com/yh5mBJn.webp'}
          onChange={handleChange}
        />
        <label htmlFor="desc">
          Postauksen kuvaus etusivulla (muutama lause):
        </label>
        <input
          id="desc"
          name="desc"
          type="text"
          defaultValue={'Kirjoita tähän lyhyt kuvaus'}
          onChange={handleChange}
        />
        <textarea
          id="content"
          name="content"
          defaultValue={'Kirjoita tähän sisältöä'}
          onChange={handleChange}
        ></textarea>
